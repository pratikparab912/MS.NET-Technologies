...
namespace AssignmentNo_02_Interfaces
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Manager m = new Manager("Ganesh", 10, 45000, "Software");
            GeneralManager gm = new GeneralManager("Amol", 20, 25000, "logistics", "promoted");
